...
The actions that remain permitted are limited to reporting the condition, identifying what remains blocked, and requesting clarification, override, or scope narrowing. Blocked halt state does not authorize substantive continuation.
